...
<title>Custom Made Men's Shirts | Formal Shirts  | Tailor Made Shirts </title>
<meta name="keywords" content="Stylior shirts, Formal shirts, Tailor made shirts, Custom made shirts , Mens dress shirts, bespoke shirts">
<meta name="description" content=" High quality custom tailored shirts online, made-to-measure with perfect fit guarantee. create your own dress shirt now, worldwide delivery.">
<!-- Bootstrap -->
...
<div class="suit-banner hidden-xs">
  ...
  <img class="img-responsive" src="<?=base_url() ?>images/img/shirt-category.jpg" />
</div>
<div class="suit-banner visible-xs">
  <img class="img-responsive" src="<?=base_url() ?>images/img/sirts-category-mobile.jpg" />
</div>
</div>
</div>
