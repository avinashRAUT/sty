            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="<?php echo $bas_ul;?>">Home</a></li>  
                 <li class="dropdown megamenu-fw">
                    ...
                    <ul class="dropdown-menu megamenu-content shop_by_category no_right_padding" role="menu">
                    	<li>
                        	<div class="row">
                            	<div class="col-md-3 shop_Category">
...
<li><a href="<?php echo $bas_ul;?>custom-vest"><div style="display:inline-block;"><img src="<?=base_url() ?>images/relaunch/suit-hover.png" width="25" height="25" alt=""/></div><div style="display:inline-block;position:ralative;top:-5px;vertical-align:top;position:relative;top:7px;left:5px;font-size:12px">DESIGN YOUR VESTS</div></a></li>
