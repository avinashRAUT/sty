...
?>
<title>Custom Made Men's Suits | Designer Suits | Formal Suits</title>
<meta name="description" content="Discover the perfect fit tailored suit at Stylior. Design your own bespoke suit online for wedding or any other occasion. Free Alterations & free shipping on all suits."/>
<meta name="keywords" content="Stylior, suits, bespoke suits, mens suits, stylior mens suits, tailored suits, casual suits, formal suits, dress suits, mens clothing, wool suits, linen suits, tailor made suits, stylior suits, custom suits./">
...
<div class="suit-banner hidden-xs">
  <img  class="img-responsive" src="<?=base_url() ?>images/img/suits-category-mobile.jpg" alt="Suits-shopping"/>
</div>
<div class="suit-banner visible-xs">
  <img  class="img-responsive" src="<?=base_url() ?>images/img/suits-category.jpg" alt="Suits-shopping"/>
</div>
</div>
</div>
